...
is intentionally loose enough to rattle against the soundboard when the string
is bowed. The musical practice centers on natural harmonics rather than
ordinary fingered stopping, with some historical variants including internal
sympathetic strings.
...
Documentation is CC BY 4.0 unless replaced by a future repository license file.
